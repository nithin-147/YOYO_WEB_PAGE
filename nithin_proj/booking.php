...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        die("Error: Username and password are required fields.");
    }
    ...
    // Database connection
    $con = new mysqli("localhost", "root", "12345", "yoyo_db");  // Change to your database name
    ...
    // We will insert only username and password, and not include the email field
